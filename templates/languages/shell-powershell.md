# Shell and PowerShell Playbook

Coverage: automation, scripts, ops, local developer workflows
...
```text
Use the language-polyglot-engineer agent for Shell and PowerShell.
