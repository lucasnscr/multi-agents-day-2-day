# Java and Kotlin Playbook

Coverage: Spring Boot, Quarkus, Micronaut, Maven, Gradle, JVM services, Android Kotlin
...
```text
Use the language-polyglot-engineer agent for Java and Kotlin.
