# JavaScript and TypeScript Playbook

Coverage: Node.js, NestJS, React, Next.js, Angular, Vue, Svelte, Vite
...
```text
Use the language-polyglot-engineer agent for JavaScript and TypeScript.
