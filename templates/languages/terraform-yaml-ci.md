# Terraform, YAML, and CI Playbook

Coverage: IaC, pipelines, Kubernetes manifests, GitHub Actions, CircleCI
...
```text
Use the language-polyglot-engineer agent for Terraform, YAML, and CI.
