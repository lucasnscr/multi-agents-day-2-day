...
def root_readme_en() -> str:
    return dedent(
        ...
        - {len(AGENTS)} specialized agents across technology, data, finance, psychology, marketing, creative work, education, and personal operations.
...
def root_readme_pt() -> str:
    return dedent(
        ...
        - {len(AGENTS)} agentes especializados em tecnologia, dados, finanças, psicologia, marketing, criação, educação e rotina pessoal.
